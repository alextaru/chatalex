module.exports = function(app){
  var Amigo     = app.models.amigos,
      validacao = require('../validacoes/contatos');
  ...
  var ContatoController = {
    ...
    post: function(req,res){
      ...
      Amigo.findById(_id, function(err,dados){
        ...
        dados.save(function(err){
          if(err){
            req.flash('erro', 'Erro ao cadastrar contatos '+err);
          }
    ...
    excluir: function(req,res){
      ...
      Amigo.findById(_id, function(err,dados){
        if(err){
          res.json(400, 'Erro ao escluir contatos: '+err);
        }
        ...
        dados.save(function(err){
          ...
          res.json(200, 'Registro excluido com sucesso!');
        });
      });
    }
  }
